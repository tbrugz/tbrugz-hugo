...
Bom, resolvi pegar os dados e fazer uns experimentos usando a linguagem [R](https://www.r-project.org/). Inicialmente transformei a tabela da página inicial do *tradingeconomics* num arquivo CSV e o carreguei (ver [tradingecon.csv](/data/2016/tradingecon.csv) - valores consultados em 22/dez/2016)
...
Afinal se temos a dívida e o juros, podemos saber o quanto um pais deve despender para que sua dívida não aumente[^div1] (este valor equivale ao montante da dívida multiplicado pelo juro real anual). Assim calcularemos o `debt_spending_real`.
...
Podemos também, e por fim, visualizar a relação entre o valor do gasto estimado com juros (coluna `debt_spending_real`) e o PIB (utilizando uma escala logaritmica para o PIB) - o que pode ser mais reveldor:
