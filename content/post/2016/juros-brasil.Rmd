...
Daí o Brasil passa para a 7ª posição (estaria a 4ª se considerarmos o juro da matéria d'*oglobo*). É possível ver também os países que menor juros têm:
...
Afinal se temos a dívida e o juros, podemos saber o quanto um pais deve despender para que sua dívida não aumente[^div1] (o valor do juro anual em relação ao montante da dívida). Assim calcularemos o `debt_spending_real`.
...
Mas podemos também visualizar a relação entre o valor do gasto estimado com juros (coluna `debt_spending_real`) e o PIB (utilizando uma escala logaritmica para o PIB) - o que pode ser mais reveldor:
